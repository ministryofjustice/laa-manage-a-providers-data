...
class TestBaseFormView:
    ...
    def test_form_valid(self):
        ...
        with patch('app.views.redirect') as mock_redirect, \
    ...
    def test_post_request_valid_form(self):
        ...
        with patch.object(view, 'get_form_class', return_value=mock_form_class), \
...
class TestBaseFormViewIntegration:
    ...
    def test_view_inheritance_patterns(self):
        ...
        view_with_overrides = CustomFormView(
            template="override.html",
            success_endpoint="override.success"
        )
